	...
	<div id="app">
		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="E-mail">
					<!-- Lazy atualiza o campo quando tira o foco
					trim tira os espaços laterais ('   Teste   ') -->
				...
				<Rotulo nome="Idade">
					<!-- Number assegura que dentro da string se tiver um valor numerico, ele mantem numerico -->
